...
const Newsletter = () => {
  return (
    <div className="h-[60vh] bg-[#fcf5f5] flex items-center justify-center flex-col">
        ...
        <div className="text-xl font-light mb-5">Get timely update from your favorite product.</div>
        <div className="flex w-1/2 h-10 bg-white items-center justify-between border border-gray-300 p-0">
